...
@javax.annotation.Generated(comments="This is the java file of the ivy data class FoodOrder", value={"ch.ivyteam.ivy.scripting.streamInOut.IvyScriptJavaClassBuilder"})
@javax.persistence.Entity
public class FoodOrder extends ch.ivyteam.ivy.scripting.objects.CompositeObject
{
  /** SerialVersionUID */
